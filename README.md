# Klippel QC Converter

Converts Klippel QC audio test result files to WATS UUT reports.
...
| **Type** | FileConverter |
| **Format** | LOG, TXT |
| **Test type** | Audio, Acoustic QC |

## About

Klippel provides test and measurement solutions for loudspeakers, headphones, and microspeakers. This converter imports end-of-line quality control test results from Klippel QC systems into WATS.
...
The recommended installation method is via the installer. Download the latest release from the [Releases](https://github.com/Virinco/WATS-Converter-Klippel-QC/releases/latest) page.

## Installation

### Using the Installer (Recommended)
1. Download the installer (`.exe`) from the [Releases](https://github.com/Virinco/WATS-Converter-Klippel-QC/releases/latest) page.
...
1. Download the `.dll` file from the [Releases](https://github.com/Virinco/WATS-Converter-Klippel-QC/releases/latest) page.
...
## Resources
- [GitHub Repository](https://github.com/Virinco/WATS-Converter-Klippel-QC)
